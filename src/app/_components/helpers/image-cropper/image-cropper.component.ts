...
import { CropperPosition, Dimensions, ImageCroppedEvent, ImageTransform, MoveStart } from '@app/_interfaces';
import { getTransformationsFromExifData, supportsAutomaticRotation } from '@app/_helpers/utils/exif.utils';
import { resizeCanvas } from '@app/_helpers/utils/resize.utils';
...
export class ImageCropperComponent implements OnChanges, OnInit {
  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if (changes.aspectRatio && this.imageVisible) {
      if (changes.aspectRatio.currentValue === undefined) {
        this.aspectRatio = this.originalSize.width / this.originalSize.height;
      }
  ...
  private initCropper(): void {
    ...
    if (this.aspectRatio === undefined || isNaN(this.aspectRatio)) {
      this.aspectRatio = this.originalSize.width / this.originalSize.height;
    }
